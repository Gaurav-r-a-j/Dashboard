...
const Ecommerce = () => {
  const { currentColor = "blue", currentMode } = useStateContext();
      ...
      <div className="flex flex-wrap  justify-center ">
        ...
        <div className="flex m-3 flex-wrap justify-center gap-4 items-center w-full">
          {earningData.map((item) => (
            <div
              key={item.title}
              className="bg-white h-44 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-56  p-4 pt-9 rounded-2xl flex-1 shadow-md "
            >
              <button
                type="button"
